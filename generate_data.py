...
parser.add_argument('--mincols',type=int,default=2,
...
parser.add_argument('--visualizeimgs',type=int,default=1,
                    help="Whether to save image files: yes [1] or no [0].")
parser.add_argument('--visualizebboxes',type=int,default=1,
                    help="Whether to save image files annotated with cell bboxes: yes [1] or no [0].")
parser.add_argument('--distributionpath',default='unlv_distribution',
                    help="Path to file containing distribution of content extracted from a set of data tables.")
...
t = TableGenerator(args.outpath,number_of_generations,args.imagespath,args.ocrpath,args.tablepath,visualizeimgs,visualizebboxes,args.distributionpath,args.minrows,args.maxrows,args.mincols,args.maxcols)
